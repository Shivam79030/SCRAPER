...
api_id = '21055678'  # Replace with your api id
api_hash = '3977bb6092323567c734bf6290816065'  # Replace with your api hash
phone_number = '+918109047626'  # Replace with your phone number
        ...
        filtered_card_info = filter_cards(message.text)
            ...
            for card_info in filtered_card_info:
                ...
                if bin_info:
                    ...
                    await client.send_message('https://t.me/payubiz_group', formatted_message, link_preview=False)
